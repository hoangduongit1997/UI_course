...
class S {
  ...
  String get swipe_to_remove {
    return Intl.message(
      'Swipe to remove item',
      name: 'swipe_to_remove',
      desc: '',
      args: [],
    );
  }

  String get descriptionlandmark {
    return Intl.message(
      'Description/Landmark',
      name: 'descriptionlandmark',
      desc: '',
      args: [],
    );
  }

  String get select_delivery_pickup {
    return Intl.message(
      'Select either Pickup or Delivery',
      name: 'select_delivery_pickup',
      desc: '',
      args: [],
    );
  }
