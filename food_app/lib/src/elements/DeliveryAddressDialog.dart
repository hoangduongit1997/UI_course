                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: new TextFormField(
                        ...
                        decoration: getInputDecoration(labelText: 'House No. / Unit No. / Bldg. Name'),
                        initialValue: address.description?.isNotEmpty ?? false ? address.description : null,
                        validator: (input) => input.trim().length == 0 ? 'Not a valid input' : null,
                    ...
                    Padding(
                      ...
                      child: new TextFormField(
                        style: TextStyle(color: Theme.of(context).hintColor),
                        keyboardType: TextInputType.text,
                        decoration: getInputDecoration(labelText: S.of(context).full_address),
