                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        new TextFormField(
                          ...
                          decoration: getInputDecoration(hintText: 'sample@email.com', labelText: S.of(context).email_address),
                        ...
                        new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                          keyboardType: TextInputType.text,
                          decoration: getInputDecoration(hintText: '09190010023', labelText: S.of(context).phone),
                          initialValue: widget.user.phone,
                          validator: (input) => input.trim().length != 11 ? S.of(context).not_a_valid_phone : null,
