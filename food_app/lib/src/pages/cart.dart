          ...
          leading: IconButton(
            onPressed: () {
              if (widget.routeArgument.param == '/Food') {
                ...
                Navigator.of(context).pushReplacementNamed('/Details', arguments: RouteArgument(id: widget.routeArgument.id, heroTag: widget.routeArgument.heroTag));
              } else{
