...
import '../elements/FeaturedSellersCarouselWidget.dart';
        ...
        title: ValueListenableBuilder(
          ...
          builder: (context, value, child) {
            return Text(
              ...
              style: Theme.of(context).textTheme.headline6.merge(TextStyle(letterSpacing: 1.0, fontWeight: FontWeight.w800)),
            ...
            children: <Widget>[
              ...
              InkWell(
                  ...
                  child: Padding(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                        'Selected Location',
                        style: Theme.of(context).textTheme.headline4.merge(TextStyle(color: Theme.of(context).hintColor,)),
                      ),
                      subtitle: Text(
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(
                    'Our Ka-Ahuy sellers of the month',
                    style: Theme.of(context).textTheme.caption,
                  ),
                ),
              ),
              FeaturedSellersCarouselWidget(restaurantsList: _con.topRestaurants, heroTag: 'home_top_restaurants'),
...
//              CardsCarouselWidget(restaurantsList: _con.topRestaurants, heroTag: 'home_top_restaurants'),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: GridWidget(
                  restaurantsList: _con.allRestaurants,
